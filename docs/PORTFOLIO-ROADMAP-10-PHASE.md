...
2. **Owner: set resonancenexus env** — site id `7fc56cb3-d5f7-4bb2-8986-a733b8cfd548`. Set `SUPABASE_SERVICE_ROLE_KEY` only. Exit: `GET https://resonancenexus.netlify.app/api/ready` 200. Then apply `supabase/migrations` including `20260925120000_execution_partial_status.sql`.
